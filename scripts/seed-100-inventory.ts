...
async function seed100Inventory(): Promise<void> {
  ...
  try {
    ...
    console.error("[WARNING] Could not connect to live MongoDB instance:", err instanceof Error ? err.message : err);
    ...
    console.log(`[SUCCESS] 100-product ZIP created at ${zipPath}. Upload this via Admin UI (/admin/products -> Import ZIP Inventory).`);
    return;
  }
